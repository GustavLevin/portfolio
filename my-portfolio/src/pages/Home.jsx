  ...
  return (
    ...
    <div className="h-screen flex flex-col justify-center items-center text-center">
      ...
      <div className="flex space-x-8">
        <a href="https://github.com/yourgithub" className="flex flex-col items-center text-white hover:text-gray-300">
          <FaGithub size={40} />
          <span className="mt-2">GitHub</span>
        </a>
        <a href="/CV.pdf" className="flex flex-col items-center text-white hover:text-gray-300">
          <FaFileAlt size={40} />
